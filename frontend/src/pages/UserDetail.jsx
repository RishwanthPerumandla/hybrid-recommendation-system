...
const UserDetail = () => {
  ...
  if (!user) {
    return (
      <Box p={3}>
        ...
        <Button variant="contained" onClick={() => navigate("/")}>Back to Users</Button>
      </Box>
    );
  }
  ...
  return (
    <Box p={3}>
      ...
      <Button variant="outlined" onClick={() => navigate("/")}>⬅️ Back to Users</Button>
